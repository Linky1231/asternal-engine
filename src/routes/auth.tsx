                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-white border border-border/70 rounded-lg px-3.5 py-2.5 text-sm outline-none transition-all duration-300 placeholder:text-muted-foreground/25 focus:border-primary/40 focus:ring-[3px] focus:ring-primary/[0.06]"
                        />
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input type={showPw ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)}
                        ...
                        className="w-full bg-white border border-border/70 rounded-lg px-3.5 pr-10 py-2.5 text-sm outline-none transition-all duration-300 placeholder:text-muted-foreground/25 focus:border-primary/40 focus:ring-[3px] focus:ring-primary/[0.06]"
                      />
                      <button type="button" onClick={() => setShowPw(!showPw)}
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground/30 hover:text-muted-foreground/60 transition-colors" tabIndex={-1}>

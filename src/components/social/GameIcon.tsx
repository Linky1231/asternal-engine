 ...
 * Estilo portada (Steam/Roblox): radio contenido, borde brillante y glow neón al pasar.
 */
export function GameIcon({
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square w-full rounded-xl overflow-hidden border border-white/10 bg-gradient-to-br from-primary/25 to-accent/20 grid place-items-center transition-[border-color,box-shadow,transform] duration-300 group-hover:border-primary/70 group-hover:shadow-[0_0_22px_-5px_oklch(0.62_0.24_292/0.65)] group-hover:scale-[1.03]`}
      >
        {post.signed_cover ? (
          <img
      ...
      {showTitle && (
        <div className="text-[10.5px] font-medium leading-tight text-center w-full line-clamp-2 min-h-[24px] text-foreground/85 group-hover:text-foreground transition-colors">
          {title}
        </div>
      )}
    </button>
